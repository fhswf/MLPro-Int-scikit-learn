...
## -------------------------------------------------------------------------------------------------
    def _setup(self, p_mode, p_ada: bool, p_visualize: bool, p_logging):
        ...
        # 5 Instantiation of Scikit-learn 'Local Outlier Factor' anomaly detector
        scikit_learn_lof = LOF( n_neighbors = 3 )

        # 6 Wrapping of the Scikit-learn algorithm and integration into the stream workflow
        ...
        task_bd.register_event_handler( p_event_id = BoundaryDetector.C_EVENT_ADAPTED, p_event_handler = task_norm.adapt_on_event )
